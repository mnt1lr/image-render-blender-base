...
def Create(bForce=False):
    ...
    if bUpdate == True:
        ...
        skBsdfRefract = nsh.bsdf.RefractionSharp(
            ngMain, "Refract Ray", (1, 1, 1, 1), skFakeIOR, skRefNormWorld
        )
        ...
        skBsdfReflect = nsh.bsdf.ReflectionSharp(
            ngMain, "Reflect Ray", (1, 1, 1, 1), skReflectNormWorld
        )
        ...
        ngMain.links.new(skMix, nodOut.inputs[sBSDF])
        nalign.Relative(skMix, (1, 0), nodOut, (0, 0), tNodeSpaceSmall)
    # endif
